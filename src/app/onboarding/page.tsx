...
const Onboarding = () => {
	...
	return (
		<div className="flex flex-col font-plus items-center min-h-screen justify-center bg-gray-100">
			<div className="md:3/4 w-11/12 h-3 fixed top-5 rounded-2xl bg-gray-200">
				<div
			...
			{step === 1 && (
				<>
					<div className="min-h-screen mt-32">
						<div className="md:3/4 w-11/12   bg-gradient-to-r from-[#FFFFFF] to-[#F7F8FA] p-3 rounded-lg shadow-lg  max-w-md mx-auto">
							<div className="p-3 border text-center rounded-lg">
								...
								<h1 className="text-xl text-[#2D2D2D] font-normal mb-2">
			...
			{step === 2 && <Onboarding1 prevStep={prevStep} nextStep={nextStep} />}

			{step === 3 && <Onboarding2 prevStep={prevStep} nextStep={nextStep} />}
			{step === 4 && <Onboarding3 prevStep={prevStep} />}
		</div>
		// </div>
	);
};
